...
# Seaborn lmplot with linear regression
sns.lmplot(x='percent_completed_hs', y='poverty_rate', data=df_combined, aspect=1.5, height=6)
plt.title('Linear Regression Between High School Graduation Rate and Poverty Rate')
